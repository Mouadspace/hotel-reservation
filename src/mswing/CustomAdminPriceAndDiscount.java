...
public class CustomAdminPriceAndDiscount extends JPanel {
    public CustomAdminPriceAndDiscount() throws IOException, FontFormatException
    {
        // Import font file
        ...
        JLabel title = new JLabel("Pricing & Discounts");
